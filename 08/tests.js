...
test_process_instruction('b inc 5 if a > 1', {})
test_process_instruction('a inc 1 if b < 5', {'a': 1})
test_process_instruction('c dec -10 if a == 0', {'c': 10})

QUnit.test('process_instructions(example1) correctly processed', function(assert) {
  assert.deepEqual(process_instructions(example1), {'a': 1, 'c': -10})
})
